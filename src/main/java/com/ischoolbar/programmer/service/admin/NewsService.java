...
public interface NewsService {
	...
	public int getNewsTotal();//获取符合条件的新闻总数
	public int getTotal(Map<String, Object> queryMap);//获取符合条件的新闻总数
	...
	public List<News> findLastCoverList(Map<String, Object> param);      //查找封面前n条新闻
}
