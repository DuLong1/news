...
<script type="text/javascript">
    ...
    var rows = 12;
    var pages=${pages};
    var newsCategory_id=${newsCategory.id};
    loadData(page, rows,newsCategory_id);
    function loadData(page, rows,newsCategory_id){
        $(".list_a").remove(); //每次重新从 API 数据接口获取数据都要先清除原先 `<div>` 的内容
        $.ajax({
            url: "../news/get_category_list",
            type: "POST",

            data:{ page:page, rows:rows,cid:newsCategory_id},
            dataType:'json',
