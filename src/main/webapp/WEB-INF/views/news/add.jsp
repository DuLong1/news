	...
	<div style="padding:10px 60px 20px 60px">
		<form id="add-form"   method="post">
			<table cellpadding="5">
				...
				<tr>
					<td>新闻来源:</td>
					<td><input class="wu-text easyui-textbox easyui-validatebox" type="text" name="tags" data-options="required:true,missingMessage:'请填写新闻来源'"></input></td>
				</tr>
				<tr>
					<td>新闻封面:</td>
					<td>
				...
				<tr  >
					<td>是否设为封面:</td>
					<td  id="test"><label><input name="cover" type="checkbox" value="1"  checked />是 </label>
						<label><input name="cover" type="checkbox" value="0" />否 </label>
					</td>

				</tr>
				<tr  style="display: none">
					<td>新闻作者:</td>
					<td><input class="wu-text easyui-textbox easyui-validatebox" type="text" name="author" ></input></td>
				</tr>
				<tr>
					<td>新闻内容:</td>
					<td>
						<textarea id="add-content" name="content"  style="width:760px;height:500px;" ></textarea>
					</td>
				</tr>
			</table>
		</form>
...
<!-- 配置文件 -->
<script  charset="utf-8" type="text/javascript" src="../../resources/admin/ueditor/ueditor.config.js"></script>
<!-- 编辑器源码文件 -->
<script  charset="utf-8" type="text/javascript" src="../../resources/admin/ueditor/ueditor.all.js"></script>
