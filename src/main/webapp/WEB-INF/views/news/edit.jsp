...
<div class="easyui-panel" title="添加新闻页面" iconCls="icon-add" fit="true" >
    <div style="padding:10px 60px 20px 60px">
        <form id="edit-form" method="post">
            ...
            <input type="hidden" id="cover" value="${news.cover}">
            <table cellpadding="5">
                <tr>
                    <td>新闻标题:</td>
                ...
                <tr>
                    <td>新闻来源:</td>
                    <td><input class="wu-text easyui-textbox easyui-validatebox" type="text" name="tags" data-options="required:true,missingMessage:'请填写新闻来源'" value="${news.tags }"></input></td>
                </tr>
                <tr>
                    <td>新闻封面:</td>
                    <td>
                ...
                <tr  >
                    <td>是否设为封面:</td>
                    <td  id="test" ><label><input  id="checkbox1"  name="cover" type="checkbox" value="1"  />是 </label>
                        <label><input name="cover" id="checkbox2" type="checkbox" value="0" />否 </label>
                    </td>

                </tr>
                <tr style="display: none">
                    <td>新闻作者:</td>
                    <td><input class="wu-text easyui-textbox easyui-validatebox" type="text" name="author"  value="${news.author }"></input></td>
                </tr>
                <tr>
                    <td>新闻内容:</td>
                    <td>
